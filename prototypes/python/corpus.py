...
# T4: Cloudline CRM
add("we discussed the CRM rollout, Cloudline licences and how the sales team will handle lead routing next quarter", "crm")
...
add("Fabrik and Nadia are both out next week so the review will slip to the following sprint", "person")
# T8: security

...
Set `SANA_MCP_VERSION` to an exact tag such as `v0.4.5` to pin an install. Linux
...
the binary from the [Releases page](https://github.com/Lumen-AiApp/sana-ai-mcp/releases)):
...
GPL-3.0. See [LICENSE](LICENSE). Maintained by [Lumen](https://lumen.com) -
[github.com/Lumen-AiApp/sana-ai-mcp](https://github.com/Lumen-AiApp/sana-ai-mcp).

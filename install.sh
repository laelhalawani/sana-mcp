...
# Pin a release:
#   curl -fsSL https://github.com/laelhalawani/sana-mcp/releases/latest/download/install.sh | SANA_MCP_VERSION=v0.4.23 sh
#   curl -fsSL https://github.com/laelhalawani/sana-mcp/releases/download/v0.4.23/install.sh | sh
set -eu
set -f
umask 077

...
func newTestModel(t *testing.T) model {
	...
	if err := database.PutTranscript("m1", []store.Line{
		{LineNo: 1, Speaker: "Julia", OriginalText: "do porownania miedzy Fabrik, a Northwind"},
		{LineNo: 2, Speaker: "Lael", StartMS: 62000, OriginalText: "we compare pricing next week"},
	}); err != nil {
...
func TestTranscriptShowsNumberedLines(t *testing.T) {
	...
	view := m.View()
	if !strings.Contains(view, "1 [0:00] Julia:") || !strings.Contains(view, "2 [1:02] Lael:") {

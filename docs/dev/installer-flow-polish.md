...
Checksum verified.
Installed -> C:\Users\dana\AppData\Local\sana-mcp\sana-mcp.exe
...
✔ Email for your Sana account: dana@example.com
A 6-digit sign-in code was just emailed to dana@example.com.
...
| `SANA_MCP_INSTALLED_PATH` | absolute path of the placed binary | `C:\Users\dana\AppData\Local\sana-mcp\sana-mcp.exe` |
...
```
   Already signed in to Sana as dana@example.com.
```
...
```
   ...
   Sent a 6-digit code to dana@example.com.

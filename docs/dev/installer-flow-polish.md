...
✔ Email for your Sana account: lael@etals.com
A 6-digit sign-in code was just emailed to lael@etals.com.
...
```
   Already signed in to Sana as lael@etals.com.
```
...
```
   ...
   ? Sign in now?  Yes
   ? Email         lael@etals.com

   Sent a 6-digit code to lael@etals.com.

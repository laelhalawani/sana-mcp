...
```
Sana - Meetings                                    dana@example.com - synced
...
```
 Participants - Pricing review with Acme (5)
   ...
   NAME                     EMAIL                          HOST
   ─────────────────────────────────────────────────────────────
   Dana Ordonez             dana@example.com                 yes
...
```
 ...
 ? Email on your Sana.ai subscription:  dana@example.com▊
```
...
2. Spinner `Sending code...` -> `await client.requestSignInCode(email)` then
   `client.save()`.
   ```
    A 6-digit code was emailed to dana@example.com.

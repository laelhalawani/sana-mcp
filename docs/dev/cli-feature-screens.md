...
```
Sana - Meetings                                    lael@lumen.com - synced
...
```
 ...
 > 2026-06-02 14:30   ready        Pricing review with Acme
   2026-06-01 11:15   downloading  1:1 Lael / Sam
...
```
 ...
 > 214  [14:03] Lael:  agreed, and the pricing objections from Acme are the
...
```
 ...
 ── Action items ──────────────────────────────────
   [ ] Send volume-based quote to Acme          Lael - due 2026-06-06
...
```
 Participants - Pricing review with Acme (5)
   ...
   NAME                     EMAIL                          HOST
   ─────────────────────────────────────────────────────────────
   Lael Ordonez             lael@lumen.com                 yes
...
```
 ...
 ? Email on your Sana.ai subscription:  lael@lumen.com▊
```
...
2. Spinner `Sending code...` -> `await client.requestSignInCode(email)` then
   `client.save()`.
   ```
    A 6-digit code was emailed to lael@lumen.com.
